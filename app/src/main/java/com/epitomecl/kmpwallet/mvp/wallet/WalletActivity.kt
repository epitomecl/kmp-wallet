...
import com.epitomecl.kmpwallet.mvp.wallet.restore.RestoreWalletFragment
import com.epitomecl.kmpwallet.mvp.wallet.restore.WalletFromSeedFragment
...
class WalletActivity : BaseActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnWalletFromSeed.setOnClickListener { onWalletFromSeed() }
    ...
    private fun buttons(restore: Int, seed: Int, backup: Int, cancel: Int) {
        btnRestoreWallet.visibility = restore
        btnWalletFromSeed.visibility = seed
    ...
    override fun onShowWalletList()
    {
        ...
        if(mPresenter.isBackupedWallet(label)) {
            buttons(View.GONE, View.GONE, View.GONE, View.GONE)
        }
        else {
            buttons(View.GONE, View.GONE, View.VISIBLE, View.GONE)
        }
    ...
    {
        buttons(View.VISIBLE, View.VISIBLE, View.GONE, View.GONE)
    ...
    override fun onRestoreWallet() {
        buttons(View.GONE, View.GONE, View.GONE, View.VISIBLE)
    ...
    override fun onWalletFromSeed() {
        buttons(View.GONE, View.GONE, View.GONE, View.VISIBLE)

        supportFragmentManager.beginTransaction()
                .replace(R.id.flWallet, WalletFromSeedFragment())
                .addToBackStack(null)
                .commit()
    }
